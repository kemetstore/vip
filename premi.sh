...
TIMES="10"
eval $(wget -qO- "https://raw.githubusercontent.com/kemetstore/kemetvip/main/Fls/botkey")
...
wget -q raw.githubusercontent.com/kemetstore/kemetvip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/kemetstore/kemetvip/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/kemetstore/kemetvip/main/Cfg/m-noobz 
